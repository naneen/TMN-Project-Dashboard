...
public class KioskController {
    ...
    public Double getPercent(Double count,Double sum){
    ...
    String revenueBar() throws JSONException, SQLException {
        ...
        Double actual = queryRevenueBar.getActual();
        Double target = queryRevenueBar.getTarget();
        Double percent = getPercent(actual,target);
    ...
    String queryPieChart() throws SQLException {
        Double countBillKisok = queryPieChart.getCountBillKiosk();
        Double countBillTRM = queryPieChart.getCountBillTRM();
        Double avgOffset = getPercent(countBillKisok,countBillKisok + countBillTRM);
        return Double.toString(avgOffset);
    }
