...
public class QueryBillTopup {
    ...
    public void getBillAmount() throws SQLException  {
        ...
        resultSetb = stateb.executeQuery("SELECT COUNT(DISTINCT TRANS_ID)  as COUNT " +
                ...
                "and (created >= TO_CHAR(SYSDATE, 'DD-MON-YYYY') and created <= TO_CHAR(SYSDATE, 'DD-MON-YYYY'))");
    ...
    public void getDate() throws SQLException  {
        ...
        //query date
        resultSetd = stated.executeQuery("SELECT TO_CHAR(SYSDATE - 28, 'DD-MON-YYYY') as TEXT FROM dual");
        resultSet1d = state1d.executeQuery("SELECT TO_CHAR(SYSDATE - 21, 'DD-MON-YYYY') as TEXT FROM dual");
        resultSet2d = state2d.executeQuery("SELECT TO_CHAR(SYSDATE - 14, 'DD-MON-YYYY') as TEXT FROM dual");
        resultSet3d = state3d.executeQuery("SELECT TO_CHAR(SYSDATE - 7, 'DD-MON-YYYY') as TEXT FROM dual");
        resultSet4d = state4d.executeQuery("SELECT TO_CHAR(SYSDATE, 'DD-MON-YYYY') as TEXT FROM dual");
