...
public class QueryCountTransaction {
    ...
    public int getCountMobileApp() throws SQLException {
        ...
        String query = "select sum(COUNT) as COUNT from " +
                ...
                "and channel = 'IOS_APP' " +
                "and amount > 0 " +
                "and create_ts between TO_DATE('20150101','yyyymmdd') and SYSDATE-"+day_ago+" " +
    ...
    public int getCountKiosk() throws SQLException {
        ...
        String query = "select COUNT(TRANS_ID) as COUNT from " +
                ...
                "where P.CREATED BETWEEN to_date('01/01/2015 00:00:00', 'dd/MM/yyyy hh24:mi:ss') and SYSDATE-"+day_ago+") ";
        resultSet = state.executeQuery(query);
        resultSet.next();
        int ans = resultSet.getInt("COUNT");
        resultSet.close();
    ...
    public int getCountTmx() throws SQLException {
        ...
        String query = "select COUNT(*) as COUNT from " +
                ...
                "and trans_date BETWEEN to_date('01/01/2015 00:00:00', 'dd/MM/yyyy hh24:mi:ss') and SYSDATE-"+day_ago+" " +
                "and response_code='0' " +
    ...
    public int getCountPaymentGate() throws SQLException {
        ...
        String query = "select sum(COUNT) as COUNT from " +
                ...
                "from payment.trans " +
                "where created_date between to_date('01/01/2015 00:00:00', 'dd/MM/yyyy hh24:mi:ss') and SYSDATE-"+day_ago+" " +
    ...
    public int getCountMasterCard() throws SQLException {
        ...
        String query = "select COUNT(*) as COUNT from " +
                ...
                "where P.CREATED_DATETIME BETWEEN to_date('01/01/2015 00:00:00', 'dd/MM/yyyy hh24:mi:ss') and SYSDATE-"+day_ago+" " +
